/**
 ******************************************************************************
 * @file      startup_stm32h750vbtx.s
 * @author    Auto-generated by STM32CubeIDE
 * @brief     STM32H750VBTx device vector table for GCC toolchain.
...
/* Copy ITCM section from FLASH to ITCMRAM */
  ldr r0, =_sitcm
  ldr r1, =_eitcm
  ldr r2, =_sitcm_loadaddr
  cmp r0, r1
  beq SkipItcmCopy
CopyItcm:
  ldr r4, [r2], #4
...
/******************************************************************************
*
* The STM32H750VBTx vector table.  Note that the proper constructs
